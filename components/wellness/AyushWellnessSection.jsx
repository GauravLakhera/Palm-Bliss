...
const systems = [
  {
    title: "Ayurveda",
    image:
      "https://cdn.pixabay.com/photo/2024/01/07/01/05/ayurveda-8492243_1280.jpg",
    description:
  ...
  return (
    <section className="py-20 bg-[#FBF7F0]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold font-playfair text-yellow-700 mb-4">
            Holistic{" "}
            <span className="">Wellness Programmes</span>
          </h2>
